...
const mobiusStoreEditPrice = '0.0000001';
...
function* run({
  ...
  if (userAccountBalance <= parseInt(mobiusStoreEditPrice, 10)) {
    yield call(fundUserAccount, userAccountNumber, mobiusStoreEditPrice);
  }
